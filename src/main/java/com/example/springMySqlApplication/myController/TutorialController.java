package com.example.springMySqlApplication.myController;

import com.example.springMySqlApplication.model.Tutorial;
import com.example.springMySqlApplication.myServices.TutorialServices;
...
public class TutorialController {
    ...
    public void updateTutorial(@PathVariable("id") long id,
